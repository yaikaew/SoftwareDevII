...
class NewVisitorTest(unittest.TestCase):  
    ...
    def test_login_and_select(self):  
        ...
        input_psw = self.browser.find_element(By.XPATH, '/html/body/div/div/form/div[2]/input')
        input_psw.send_keys(password + Keys.ENTER)
        ...
        time.sleep(2)
        search_box.send_keys('database' + Keys.ENTER)
        time.sleep(2)

        #เจอdatabaseแล้ว เลยลองกดเลือก
        ...
        time.sleep(2)
        database = self.browser.find_element(By.XPATH, '//*[@id="section-b"]/div/form/button').send_keys(Keys.ENTER)
        time.sleep(2)
